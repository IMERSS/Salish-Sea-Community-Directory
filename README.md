# Salish Sea Community Directory

This project hosts a structure for building out and publishing a map-based scrollytelling
interface for the Salish Sea Community Directory maintained by the [Hakai Institute](https://hakai.org/)
based on [R Markdown](https://rmarkdown.rstudio.com/).

You can browse the published output of this project in these documents:

* [Raw Storymapping Output](https://imerss.github.io/Salish-Sea-Community-Directory/Salish_Sea_Community_Directory.html)
* [Storymapping Reknitted into Scrollytelling
  Interface](https://imerss.github.io/Salish-Sea-Community-Directory/Salish_Sea_Community_Directory-Reknitted.html)
